...
set_load -pin_load 0.1900 [get_ports {led_enb[7]}]
set_load -pin_load 0.1900 [get_ports {led_enb[6]}]
set_load -pin_load 0.1900 [get_ports {led_enb[5]}]
set_load -pin_load 0.1900 [get_ports {led_enb[4]}]
set_load -pin_load 0.1900 [get_ports {led_enb[3]}]
set_load -pin_load 0.1900 [get_ports {led_enb[2]}]
set_load -pin_load 0.1900 [get_ports {led_enb[1]}]
set_load -pin_load 0.1900 [get_ports {led_enb[0]}]
set_load -pin_load 0.1900 [get_ports {leds[7]}]
set_load -pin_load 0.1900 [get_ports {leds[6]}]
set_load -pin_load 0.1900 [get_ports {leds[5]}]
set_load -pin_load 0.1900 [get_ports {leds[4]}]
set_load -pin_load 0.1900 [get_ports {leds[3]}]
set_load -pin_load 0.1900 [get_ports {leds[2]}]
set_load -pin_load 0.1900 [get_ports {leds[1]}]
set_load -pin_load 0.1900 [get_ports {leds[0]}]
