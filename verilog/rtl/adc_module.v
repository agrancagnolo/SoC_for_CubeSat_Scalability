...
(* blackbox *)
module adc_module(
    input wire    i_adc_data_p,
    input wire    i_adc_data_n,
    input wire    i_adc_load,
    input wire    i_adc_conv_start,
    input wire    i_adc_data_config,
    input wire    i_adc_reset,
    input wire    i_adc_clock,
    output reg     o_adc_data,
    output reg     o_conv_finished
);
